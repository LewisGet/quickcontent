 ...
 * list Table class
 */
class QuickcontentTableList extends JTable
{
	/**
	 * Constructor
	 *
	...
	{
		parent::__construct('#__quickcontent_lists', 'id', $db);
	}
    ...
    {
        $k = $this->_tbl_key;
        return 'com_quickcontent.list.' . (int) $this->$k;
    }
	...
	public function rebuild($parentId = null, $leftId = 0, $level = 0, $path = '')
	{
		if(!$parentId){
			...
			$table = JTable::getInstance('List', 'QuickcontentTable') ;
			if( !$table->load(1) ){
				$k = $this->_tbl_key;
