 ...
 */
class QuickcontentModelLists extends AKModelList
{
	/**
    ...
    public function __construct($config = array())
    {
        ...
        if (empty($config['filter_fields'])) {
            ...
            $config['filter_fields'] = QuickcontentHelper::_('db.mergeFilterFields', $config['filter_fields'] , $config['tables'] );
        }
	...
	protected function getListQuery()
	{
		...
		// get select columns
		$select = QuickcontentHelper::_( 'db.getSelectList', $this->config['tables'] );
		
		//build query
		$q->select($select)
			->from('#__quickcontent_lists AS a')
