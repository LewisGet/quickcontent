...
<div class="modal hide fade" id="batchModal">
	<div class="modal-header">
		...
		<h3><?php echo JText::_('COM_QUICKCONTENT_BATCH_OPTIONS');?></h3>
	</div>
<?php else: ?>
<fieldset class="batch">
	<legend><?php echo JText::_('COM_QUICKCONTENT_BATCH_OPTIONS');?></legend>
	
<?php endif; ?>
	
	<div class="modal-body">
	
		<p><?php echo JText::_('COM_QUICKCONTENT_BATCH_TIP'); ?></p>
		...
		<div class="control-group">
			<div class="controls">
			<?php echo JHtml::_('batch.item', 'com_quickcontent');?>
			</div>
		</div>
		<?php endif; ?>
...
<?php if( JVERSION >= 3 ): ?>
	<div class="modal-footer">
		...
		<button class="btn btn-primary" type="submit" onclick="Joomla.submitbutton('list.batch');">
...
<?php else: ?>
	<div class="modal-footer">
		<button class="btn"  type="submit" onclick="Joomla.submitbutton('list.batch');">
			<?php echo JText::_('JGLOBAL_BATCH_PROCESS'); ?>
		</button>
